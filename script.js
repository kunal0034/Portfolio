...
// Create Hexagonal Background with Movement
function createHexagons() {
    ...
    for (let i = 0; i < hexCount; i++) {
        ...
        hexagon.style.height = `${size * 0.5774}px`;
        hexagon.style.left = `${x}%`;
        hexagon.style.top = `${y}%`;
        hexagon.style.opacity = 0.05 + Math.random() * 0.1;
...
// Hexagonal Background Grid (Original functionality)
